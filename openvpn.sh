...
wget -O ~/EasyRSA-3.0.5.tgz "https://github.com/OpenVPN/easy-rsa/releases/download/v3.0.5/EasyRSA-nix-3.0.5.tgz"
...
wget -O /etc/lighttpd/lighttpd.conf https://raw.githubusercontent.com/chunliu/simple-openvpn-server/master/lighttpd.conf

#install the webserver scripts
rm /var/www/html/*
wget -O /var/www/html/index.sh https://raw.githubusercontent.com/chunliu/simple-openvpn-server/master/index.sh

wget -O /var/www/html/download.sh https://raw.githubusercontent.com/chunliu/simple-openvpn-server/master/download.sh
chown -R www-data:www-data /var/www/html/

#set the password file for the WWW logon
echo "vpnadmin:$ADMINPASSWORD" >> /etc/lighttpd/.lighttpdpassword
